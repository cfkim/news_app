      ...
      body: Column(children: [
        ...
        Container(
          child: Column(children: [
            Text('Joe Smith'),
            Text('Phildelphia, PA', style: TextStyle(color: Color(0xFF8F90A7))),
            SizedBox(height: 10),
            Padding(
                  ...
                  children: [
                    ClipRRect(
                      borderRadius: BorderRadius.only(
                        topLeft: Radius.circular(6), // Radius for top-left corner
                        topRight: Radius.circular(6), // Radius for top-right corner
                      ),
                      child: Image.asset(
                        post.imageUrl,
                        fit: BoxFit.cover,
                    ...
                    Padding(
                      ...
                      child: Text(
                        post.content,
                        maxLines: 2, // Adjust this to control the number of lines
                        overflow: TextOverflow.ellipsis, // Adds "..." at the end of the truncated text
                      ),
                    ),
                  ],
                ),
